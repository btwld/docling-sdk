...
/**
 * Simple JWT auth guard for demonstration purposes
 * In a real application, you would use a proper JWT library and validation
 */
@Injectable()
export class JwtAuthGuard implements CanActivate {
  // Demo secret key - in a real app, this would be in environment variables
  private readonly secretKey = 'mcp-auth-example-secret-key';
